...
public interface BioProto {
  ...
  java.lang.Void transferFile(java.util.List<br.unb.cic.bionimbus.avro.gen.NodeInfo> plugins, java.lang.String path, int copies, java.util.List<java.lang.String> destprimary) throws org.apache.avro.AvroRemoteException;
  ...
  public interface Callback extends BioProto {
    ...
    void transferFile(java.util.List<br.unb.cic.bionimbus.avro.gen.NodeInfo> plugins, java.lang.String path, int copies, java.util.List<java.lang.String> destprimary, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
