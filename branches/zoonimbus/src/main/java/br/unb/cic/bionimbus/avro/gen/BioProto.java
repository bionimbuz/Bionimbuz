...
public interface BioProto {
  ...
  java.lang.Void transferFile(java.util.List<br.unb.cic.bionimbus.avro.gen.NodeInfo> plugins, br.unb.cic.bionimbus.avro.gen.NodeInfo nodedest, br.unb.cic.bionimbus.avro.gen.FileInfo file, java.lang.String path, int copies) throws org.apache.avro.AvroRemoteException;
  ...
  public interface Callback extends BioProto {
    ...
    void transferFile(java.util.List<br.unb.cic.bionimbus.avro.gen.NodeInfo> plugins, br.unb.cic.bionimbus.avro.gen.NodeInfo nodedest, br.unb.cic.bionimbus.avro.gen.FileInfo file, java.lang.String path, int copies, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
