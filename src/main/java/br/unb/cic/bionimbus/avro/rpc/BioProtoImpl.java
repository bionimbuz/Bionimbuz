...
public class BioProtoImpl implements BioProto {
    ...
    public List<br.unb.cic.bionimbus.avro.gen.PluginFile> listFiles() throws AvroRemoteException {
        ...
        final HashSet<br.unb.cic.bionimbus.avro.gen.PluginFile> listFiles = new HashSet<>();
        ...
        final List<br.unb.cic.bionimbus.avro.gen.PluginFile> listFile = new ArrayList<>(listFiles);
    ...
    private br.unb.cic.bionimbus.avro.gen.PluginFile getPluginFile(String fileName) {
        try {
            for (final br.unb.cic.bionimbus.avro.gen.PluginFile file : this.listFiles()) {
    ...
    public br.unb.cic.bionimbus.avro.gen.PluginFile getFileFromPeers(String filename) throws AvroRemoteException {
        final br.unb.cic.bionimbus.avro.gen.PluginFile pluginFile = this.storageService.getFileInfoByFilename(filename);
        
        if (pluginFile == null) {
            final br.unb.cic.bionimbus.avro.gen.PluginFile pfile = new br.unb.cic.bionimbus.avro.gen.PluginFile();
