...
public class PluginFile extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    public long size;
    @Deprecated
    public java.util.List<java.lang.String> pluginId;
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            ...
            case 3:
                ...
                break;
            case 4:
                pluginId = (java.util.List<java.lang.String>) value$;
                break;
            default:
                throw new org.apache.avro.AvroRuntimeException("Bad index");
        }
     ...
     */
    public static br.unb.cic.bionimbus.avro.gen.PluginFile.Builder newBuilder() {
        return new br.unb.cic.bionimbus.avro.gen.PluginFile.Builder();
    }

    /**
     * Creates a new PluginFile RecordBuilder by copying an existing Builder
     */
    public static br.unb.cic.bionimbus.avro.gen.PluginFile.Builder newBuilder(br.unb.cic.bionimbus.avro.gen.PluginFile.Builder other) {
        return new br.unb.cic.bionimbus.avro.gen.PluginFile.Builder(other);
    }

    /**
     * Creates a new PluginFile RecordBuilder by copying an existing PluginFile
     * instance
     */
    public static br.unb.cic.bionimbus.avro.gen.PluginFile.Builder newBuilder(br.unb.cic.bionimbus.avro.gen.PluginFile other) {
        return new br.unb.cic.bionimbus.avro.gen.PluginFile.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PluginFile>
         ...
         */
        private Builder() {
            super(br.unb.cic.bionimbus.avro.gen.PluginFile.SCHEMA$);
        }

        /**
         * Creates a Builder by copying an existing Builder
         */
        private Builder(br.unb.cic.bionimbus.avro.gen.PluginFile.Builder other) {
            super(other);
        }
         ...
         */
        private Builder(br.unb.cic.bionimbus.avro.gen.PluginFile other) {
            super(br.unb.cic.bionimbus.avro.gen.PluginFile.SCHEMA$);
         ...
         * Sets the value of the 'id' field
         */
        public br.unb.cic.bionimbus.avro.gen.PluginFile.Builder setId(java.lang.String value) {
         ...
         */
        public br.unb.cic.bionimbus.avro.gen.PluginFile.Builder clearId() {
            id = null;
         ...
         * Sets the value of the 'path' field
         */
        public br.unb.cic.bionimbus.avro.gen.PluginFile.Builder setPath(java.lang.String value) {
         ...
         */
        public br.unb.cic.bionimbus.avro.gen.PluginFile.Builder clearPath() {
            path = null;
         ...
         * Sets the value of the 'name' field
         */
        public br.unb.cic.bionimbus.avro.gen.PluginFile.Builder setName(java.lang.String value) {
         ...
         */
        public br.unb.cic.bionimbus.avro.gen.PluginFile.Builder clearName() {
            name = null;
