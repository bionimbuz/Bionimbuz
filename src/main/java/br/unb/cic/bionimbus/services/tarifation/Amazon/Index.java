...
public class Index {
    ...
    public Index(String server,String index) throws JSONException, IOException {
        ...
        //String amazonServicesURLs = this.getter.get(server, index);
        System.out.println(amazonServicesURLs.toString());
        //JSONObject amazonURLs = new JSONObject(amazonServicesURLs);
    }
}
